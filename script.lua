...
-- Link to be copied
local siteLink = "https://linkvertise.com/1274744/jujutsu-infinite?o=sharing" -- Put your desired link here
...
checkKeyButton.MouseButton1Click:Connect(function()
    if keyInput.Text == "JJINFKG" then
        ...
        local success, errorMessage = pcall(function()
            loadstring(game:HttpGet("https://paste.ee/r/hfHyO"))()
        end)
